<template>
  <div class="space-y-5">
    ...
    >
      <div
        class="w-10 h-10 border-2 border-blue-500 border-t-transparent rounded-full animate-spin"
      />

      <p class="text-white mt-4 font-medium">
        Validating Bank Statement Data
      </p>
    ...
    <template v-else>
      ...
      <div class="bg-slate-900 border border-slate-800 rounded-2xl p-6">
        <h1 class="text-xl font-semibold text-white">
          Settlement Bank Statement Validation
        </h1>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          >
            ...
            <span
              class="px-3 py-1 rounded-lg bg-emerald-500/10 text-emerald-400 text-xs font-medium"
            >
              Match
            </span>
          </div>
        ...
        >
          ...
          >
            ...
            <span
              class="px-3 py-1 rounded-lg bg-blue-500/10 text-blue-400 text-xs font-medium"
            >
              Validation
            </span>
          </div>
        ...
        >
          <div>
            ...
            <p class="text-slate-500 text-sm mt-1">
              Bank Statement comparison by month
            </p>
          </div>

          <div
            class="px-3 py-1 rounded-lg bg-slate-800 text-slate-300 text-sm"
          >
            {{ rows.length }} Months
          </div>
        </div>
        ...
        <div class="overflow-auto">
          <table class="w-full min-w-[1000px]">
            ...
            <thead class="bg-slate-950">
              <tr>
                <th
                  class="px-6 py-4 text-left text-sm font-medium text-slate-400"
                >
                  Month
                </th>

                <th
                  class="px-6 py-4 text-right text-sm font-medium text-slate-400"
                >
                  Website
                </th>
                ...
                <th
                  class="px-6 py-4 text-center text-sm font-medium text-slate-400"
                >
                  Web ↔ Mobile
                </th>
            ...
            <tbody>
              ...
              >
                ...
                <td
                  class="px-6 py-4 text-right text-white"
                >
...
async function validateData() {
  ...
  try {
    ...
    for (
      ...
      const web = website.find(
        (item: any) =>
          item.month === month
      )

      const mob = mobile.find(
        (item: any) =>
          item.month === month
      )
